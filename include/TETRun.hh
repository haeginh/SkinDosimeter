...
{
public:
 explicit TETRun(TETModelImport* tetData);
 virtual ~TETRun();
 ...
 EDEPMAP* GetSkinDoseMap() {return &fSkinDoseMap;}
 ...
 G4double GetEff() {return eff;}
 G4double GetEff2() {return eff2;}
 G4double GetEff_DRF() {return eff_drf;}
 G4double GetEff_DRF2() {return eff_drf2;}
...
private:
 ...
 EDEPMAP fEdepMap;
 EDEPMAP fSkinDoseMap;
 double eff, eff2, eff_drf, eff_drf2;
 G4int fCollID, fCollID_skin, fCollID_drf;
 G4String primary;
 G4String dir;
 G4double primaryE;
 G4double beamArea;
